...
class CESIUM3DTILES_API Cesium3DTileset {
public:
    /// <summary>
    ...
    Cesium3DTileset(const Cesium3DTilesetExternals& externals, const std::string& url);
    ...
    Cesium3DTileset(const Cesium3DTilesetExternals& externals, uint32_t ionAssetID, const std::string& ionAccessToken);
...
private:
    ...
    Cesium3DTileset(const Cesium3DTileset& rhs) = delete;
    Cesium3DTileset& operator=(const Cesium3DTileset& rhs) = delete;
};
