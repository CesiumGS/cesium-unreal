...
# Use the MSVC toolset version from the environment if provided.
if(DEFINED ENV{VCPKG_PLATFORM_TOOLSET_VERSION} AND NOT "$ENV{VCPKG_PLATFORM_TOOLSET_VERSION}" STREQUAL "")
...
if(DEFINED ENV{CI})
  ...
  if(EXISTS "${UNREAL_ENGINE_BUILD_VERSION_FILENAME}")
    ...
    if("${UNREAL_MAJOR_VERSION}" GREATER "5" OR "${UNREAL_MINOR_VERSION}" GREATER_EQUAL "7")
      # This is UE 5.7+, so use MSVC 14.44.
      set(VCPKG_PLATFORM_TOOLSET_VERSION "14.44")
    elseif("${UNREAL_MAJOR_VERSION}" GREATER "5" OR "${UNREAL_MINOR_VERSION}" GREATER_EQUAL "5")
