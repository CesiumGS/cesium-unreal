...
- `CesiumMetadataFeatureTable` and `CesiumMetadataPrimitiveBlueprintLibrary.GetFeatureTables` have been removed. These have been deprecated since Unreal Engine 4.26.
