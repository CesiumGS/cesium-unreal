...
$CESIUM_PYTHON conan editable add conan/recipes/openssl-ue4.26 openssl/UE4.26
$CESIUM_PYTHON conan editable add conan/recipes/openssl-ue4.27 openssl/UE4.27
