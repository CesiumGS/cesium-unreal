...
//        pNode->isDataReady = this->_dataTextures.isSlotLoaded(pNode->dataIndex);
//        continue;
//      }
//
...
//        this->_dataTextures.release(pLowestPriorityNode->dataIndex);
...
//
//      pNode->dataIndex = this->_dataTextures.add(*pVoxel);
