...
static void ClearAutoGeneratedNodes(
  ...
  for (UMaterialExpression* AutoGeneratedNode :
    ...
    pLayer->GetExpressionCollection().RemoveExpression(AutoGeneratedNode);
  }
}
