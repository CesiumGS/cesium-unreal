...
struct MaterialGenerationState {
  ...
  struct ConnectionInput {
    const FExpressionInput* pUserNode = nullptr;
    FString autogeneratedNodeName;
    FString autogeneratedOutputName;
  };
   ...
   */
  TMap<FString, TMap<FString, ConnectionInput>> ConnectionInputRemap;
};
