...
void GenerateStatisticsNodes(
  ...
  for (const FCesiumMetadataPropertyStatisticsDescription& propertyStatistics :
    ...
    for (const FCesiumMetadataPropertyStatisticValue& statisticValue :
      ...
      FString parameterName =
          createHlslSafeName(ClassStatistics.Id + "_" + propertyStatistics.Id);

      switch (statisticValue.Semantic) {
      case ECesiumMetadataStatisticSemantic::Min:
        parameterName += MaterialPropertyMinSuffix;
        break;
      case ECesiumMetadataStatisticSemantic::Max:
        parameterName += MaterialPropertyMaxSuffix;
        break;
      default:
        // UE_LOG?
        continue;
      ...
      pParameter->ParameterName =
          FName(parameterName + MaterialTexCoordIndexSuffix);
