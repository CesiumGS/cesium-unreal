...
const TSharedPtr<FCesiumTextureResourceBase>&
...
void ReferenceCountedUnrealTexture::setTextureResource(
    TSharedPtr<FCesiumTextureResourceBase>&& p) {
...
TSharedPtr<FCesiumTextureResourceBase> createTextureResourceFromImageCesium(
  ...
  if (GRHISupportsAsyncTextureCreation && !imageCesium.pixelData.empty()) {
    ...
    TSharedPtr<FCesiumTextureResourceBase> textureResource =
        MakeShared<FCesiumUseExistingTextureResource>(
            textureReference,
            group,
            imageCesium.width,
            imageCesium.height,
    ...
    return MakeShared<FCesiumCreateNewTextureResource>(
...
struct ExtensionUnrealTextureResource {
  ...
  static TSharedPtr<FCesiumTextureResourceBase> loadTextureResource(
      CesiumGltf::ImageCesium& imageCesium,
      TextureAddress addressX,
      TextureAddress addressY,
      TextureFilter filter,
    ...
    if (extension.pTextureResource != nullptr) {
      return MakeShared<FCesiumUseExistingTextureResource>(
    ...
    extension.pTextureResource = textureResource;
  ...
  TextureFilter
  getTextureFilterFromSampler(const CesiumGltf::Sampler& sampler) {
    ...
    if (sampler.magFilter && !sampler.minFilter) {
      ...
      return sampler.magFilter.value() ==
                     CesiumGltf::Sampler::MagFilter::NEAREST
  ...
  loadTextureGameThreadPart(
    ...
    if (pResult && pHalfLoadedTexture &&
        pHalfLoadedTexture->textureIndex >= 0 &&
  ...
  loadTextureGameThreadPart(LoadedTextureResult* pHalfLoadedTexture) {
    ...
    TSharedPtr<FCesiumTextureResourceBase>& pTextureResource =
    ...
    if (pCesiumTextureResource) {
      ...
      ([pTexture,
        pCesiumTextureResource](FRHICommandListImmediate& RHICmdList) {
  ...
  TSharedPtr<FCesiumTextureResourceBase> createTextureResource(
    ...
    return createTextureResourceFromImageCesium(
        imageCesium,
