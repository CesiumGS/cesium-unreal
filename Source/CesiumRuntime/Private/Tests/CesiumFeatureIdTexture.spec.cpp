...
void FCesiumFeatureIdTextureSpec::Define() {
  Describe("Constructor", [this]() {
    ...
    //   const int64 attributeIndex = 0;
    //   const std::vector<uint8_t> featureIDs{0, 0, 0, 3, 3, 3, 1, 1, 1, 2, 2,
    //   2}; AddFeatureIDsAsAttributeToModel(
    //       model,
    //       *pPrimitive,
    //       featureIDs,
    //       4,
  ...
  //    const int64 attributeIndex = 0;
  //    const std::vector<uint8_t> featureIDs{0, 0, 0, 3, 3, 3, 1, 1, 1, 2, 2,
  //    2}; const int64 vertexCount = static_cast<int64>(featureIDs.size());
  ...
  //  It("returns correct value for valid attribute", [this]() {
  //    const int64 attributeIndex = 0;
  //    const std::vector<uint8_t> featureIDs{0, 0, 0, 1, 1, 1, 2, 2, 2, 3, 3,
  //    3}; AddFeatureIDsAsAttributeToModel(
  //        model,
  //        *pPrimitive,
  //        featureIDs,
  //        4,
