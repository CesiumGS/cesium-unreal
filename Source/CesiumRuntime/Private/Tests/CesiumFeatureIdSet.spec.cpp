...
void FCesiumFeatureIdSetSpec::Define() {
  ...
  Describe("GetFeatureIDFromHit", [this]() {
    BeforeEach([this]() {
      ...
      pPrimData = pPrimitiveComponent->getPrimitiveData();
      pPrimData->pMeshPrimitive = pPrimitive;
    ...
    It("returns -1 for invalid hit component", [this]() {
      ...
      pPrimData->PositionAccessor = CesiumGltf::AccessorView<FVector3f>(
          model,
    ...
    It("returns correct value for texture set", [this]() {
      ...
      pPrimData->PositionAccessor =
          CesiumGltf::AccessorView<FVector3f>(model, positionAccessorIndex);
      pPrimData->TexCoordAccessorMap.emplace(
          0,
