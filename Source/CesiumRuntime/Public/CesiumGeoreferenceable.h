...
public:
	...
	/**
	 * Notifies georeferenced objects that the underlying georeference transforms have been updated. The new
	 * transforms can be fetched from the `CesiumWorldGeoreference` actor. 
	 */
