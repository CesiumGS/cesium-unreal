...
UENUM()
enum class ECesiumPropertyComponentType : uint8 {
  Uint8,
  Float
};

UENUM()
enum class ECesiumPropertyType : uint8 {
  Scalar,
  Vec2,
  Vec3,
  Vec4
...
struct CESIUMRUNTIME_API FPropertyDescription {
  ...
  UPROPERTY(
      EditAnywhere,
      Category = "Cesium")
  ECesiumPropertyComponentType ComponentType = ECesiumPropertyComponentType::Float;
...
class CESIUMRUNTIME_API UCesiumEncodedMetadataComponent : public UActorComponent {
  GENERATED_BODY()
